...
Addendum to **03_publishing_agent.json**. Until these are implemented in the workflow, follow the manual/spec steps below.
...
**Status:** Documented here as manual/spec until implemented in 03_publishing_agent.json (or in a Code node referenced by it).
...
**Status:** Documented here as manual step and spec until implemented in 03_publishing_agent.json or a linked sub-workflow.

---

**When implementing in n8n:** Re-export 03_publishing_agent.json after changes and update this addendum if the behavior is fully in the JSON; otherwise keep this file as the spec for throttle and Notion path.
