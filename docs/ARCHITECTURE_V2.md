...
|------|----------|--------|--------|
| `workflows/01_research_agent.json` | Weekly Trend Researcher | ✅ Existing | Add brand config call |
| `workflows/02B_product_creation_factory.json` | Product Creator | ✅ Existing | Add brand styling + halal check |
| `workflows/03_publishing_agent.json` | Store Publisher | ✅ Existing | Add brand credential routing |
| `workflows/04_social_agent.json` | Social Promoter | ✅ Existing | Add brand social account routing |
| `workflows/05_humanization_agent.json` | Humanizer + Prompt Engineer | ✅ Existing | Add brand voice injection |
| `workflows/06_brand_config.json` | **Brand Config System** | 🆕 NEW | Master brand registry |
| `workflows/07_halal_guardian.json` | **Halal Guardian Agent** | 🆕 NEW | Content compliance screening |
...
### Patch workflows/01_research_agent.json
...
### Patch workflows/02B_product_creation_factory.json
...
### Patch workflows/03_publishing_agent.json
...
### Patch workflows/04_social_agent.json
...
### Patch workflows/05_humanization_agent.json
